...
\begin{example} {\color{red} Musite napisat, ze sa jedna o SN implikatory}
\cite{hlinena}
Pro základní t-konormy zmíněné v kapitole \ref{sec: Triangulární konormy} a standardní negátor $N_S$ existují následující implikátory, které se také nazývají SN implikátory:\\
...
\begin{example} {\color{red} tu tiez treba napisat, ze ake su to implikatory a z coho vznikli-strucne-1-2 vety.}
    \cite{hlinena}\\
...
\end{example}
{\color{red} Nejaka veta, ze si vypiseme zoznam vlastnosti-tieto vlastnosti splna klasicka implikacia, ale nie vsetky fuzzy implikacie ich splnaju, cize zase mame moznost nejako ich roztriedit podla vlastnosti. Tak 2-3 vety.}
\begin{definition}
\cite{hlinena}
...
{\color{red} toto cele treba ucesat, aby bolo jasne, co chcete vlastne povedat, mal by tam byt nejaky uvod, potom zoznam znamych konstrukcii a ku kazdej mozete hodit priklad-skuste to prerobit, ja to cez vikend potom dorazim}
