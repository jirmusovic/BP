...
\projectinfo{
  ...
  title.cs={Fuzzy teorie grafů},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Fuzzy graphs theory}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Ducký},   % příjmení autora / author surname 
...
\newtheorem{lemma}{Príklad}[section]
\newtheorem{theorem}{Definícia}[section]
\newtheorem{corollary}{Poznámka}[section]
